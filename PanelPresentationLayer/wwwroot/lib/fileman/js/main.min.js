...
RoxyUtils.GetFileIcon = function (a) {
    ret = "/lib/fileman/images/filetypes/unknown.png";
    if (fileTypeIcons[RoxyUtils.GetFileExt(a).toLowerCase()]) {
        ret = "/lib/fileman/images/filetypes/" + fileTypeIcons[RoxyUtils.GetFileExt(a).toLowerCase()];
    }
    return ret;
};
...
RoxyUtils.LoadLang = function () {
    ...
    if (RoxyFilemanConf.LANG && RoxyFilemanConf.LANG.toLowerCase() == "auto") {
        if (RoxyUtils.GetUrlParam("langCode")) {
            a = "/lib/fileman/lang/" + RoxyUtils.GetUrlParam("langCode").substr(0, 2).toLowerCase() + ".json";
        } else {
            var b = window.navigator.userLanguage || window.navigator.language;
            a = "/lib/fileman/lang/" + b.substr(0, 2) + ".json";
        }
        ...
        if (RoxyFilemanConf.LANG) {
            a = "/lib/fileman/lang/" + RoxyFilemanConf.LANG.substr(0, 2).toLowerCase() + ".json";
            if (!RoxyUtils.FileExists(a)) {
                a = "";
            }
        }
...
function File(d, a, c, b, e) {
    ...
    this.Show = function () {
        html =
            ...
            this.size +
            '" data-icon-big="' +
            (this.IsImage() ? this.fullPath : this.bigIcon) +
            '" title="' +
            this.name +
            '">';
        ...
        if (RoxyFilemanConf.MOVEFILE) {
            f.draggable({ helper: makeDragFile, start: startDragFile, cursorAt: { left: 10, top: 10 }, delay: 200 });
        }
        f.click(function (g) {
            selectFile(this);
        });
        ...
        f.tooltip({ show: { delay: 700 }, track: true, content: tooltipContent });
...
function Directory(a, c, b) {
    ...
    this.SetEvents = function () {
        ...
        if (RoxyFilemanConf.MOVEDIR) {
            d.draggable({ helper: makeDragDir, start: startDragDir, cursorAt: { left: 10, top: 10 }, delay: 200 });
        }
        d = d.children("div");
        d.click(function (f) {
            selectDir(this);
        ...
        d.bind("contextmenu", function (g) {
            ...
            $("#menuDir")
                .css({ top: f + "px", left: g.pageX + "px" })
                .show();
            return false;
        });
        d.droppable({ drop: moveObject, over: dragFileOver, out: dragFileOut });
    ...
    this.GetHtml = function () {
        ...
        d += '<div><img src="/lib/fileman/images/' + (this.dirs > 0 ? "dir-plus.png" : "blank.gif") + '" class="dirPlus" width="9" height="9">';
        d += '<img src="/lib/fileman/images/folder.png" class="dir"><span class="name">' + this.name + " (" + this.files + ")</span></div>";
        d += "</li>";
        return d;
    };
    ...
    this.Select = function (e) {
        ...
        d.children("img.dir").prop("src", "/lib/fileman/images/folder.png");
        this.SetStatusBar();
    ...
    this.SetOpened = function () {
        ...
        if (d.find("li").length < 1) {
            d.children("div").children(".dirPlus").prop("src", "/lib/fileman/images/blank.gif");
        } else {
            if (this.IsExpanded()) {
                d.children("div").children(".dirPlus").prop("src", "/lib/fileman/images/dir-minus.png");
            } else {
                d.children("div").children(".dirPlus").prop("src", "/lib/fileman/images/dir-plus.png");
            }
        }
    };
...
function makeDragDir(b) {
    ...
    return '<div class="pnlDragDir" data-path="' + a.fullPath + '"><img src="/lib/fileman/images/folder.png" align="absmiddle">&nbsp;' + a.name + "</div>";
}
...
function addDir() {
    ...
    $("#pnlDirName").dialog({ title: t("T_CreateDir"), modal: true, buttons: a });
}
...
function showUploadList(b) {
    ...
    for (i = 0; i < b.length; i++) {
        a.append(
            '<div class="fileUpload"><div class="fileName">' +
            b[i].name +
            " (" +
            RoxyUtils.FormatFileSize(b[i].size) +
            ')<span class="progressPercent"></span><div class="uploadProgress"><div class="stripes"></div></div></div><a class="removeUpload" onclick="removeUpload(' +
            i +
            ')"></a></div>'
        );
    }
...
function addFile() {
    ...
    $("#dlgAddFile").dialog({ title: t("T_AddFile"), modal: true, buttons: a, width: 400 });
}
...
function renameDir() {
    ...
    $("#pnlDirName").dialog({ title: t("T_RenameDir"), modal: true, buttons: a });
...
function renameFile() {
    ...
    $("#pnlRenameFile").dialog({ title: t("T_RenameFile"), modal: true, buttons: a });
