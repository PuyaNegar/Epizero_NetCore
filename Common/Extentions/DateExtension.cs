...
namespace Common.Extentions
{
    ...
    {
        public static DateTime ConvertUnixToDateTime(this long Milliseconds)
        {
            DateTime dateUnix = new DateTime(1970, 1, 1, 0, 0, 0);
            return dateUnix.AddMilliseconds(Milliseconds);
        }
        //===================================================================
        ...
        {
            TimeZoneInfo timeZone = TimeZoneInfo.FindSystemTimeZoneById(AppConfigProvider.GetTimeZone());
            if (timeZone.IsDaylightSavingTime(utcTime) && !AppConfigProvider.GetIsApplyDaylightSaving())
            {
        ...
        public static DateTime ToUtcDateTime(this DateTime dateTime )
        {
            try
            {
                ...
                if (timeZone.IsDaylightSavingTime(dateTime) && !AppConfigProvider.GetIsApplyDaylightSaving())
                {
                    utcTime = utcTime.AddHours(1);
                } 
                return utcTime; 
            ...
            {
                var timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById(AppConfigProvider.GetTimeZone());
        ...
        {
            long unixTimestamp = (Int64)(date.Subtract(new DateTime(1970, 1, 1))).TotalMilliseconds;
