...
namespace TeacherBusinessLogicLayer.BusinessComponents.FinancialsComponents
{
    public class TeacherCourseStudentFinancialsComponent : IDisposable
    {
        ...
        {
            var result = courseMeetingStudentsRepository.Where(c => c.IsActive && c.CourseId == courseId && c.Course.TeacherUserId == teacherUserId , c=>c.StudentUsers.StudentUserProfile.City , c=>c.CourseMeeting.Course , c=>c.Course);
            return result;
        }
        //===============================================
