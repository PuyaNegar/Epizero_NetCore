...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210601143450_14000311-1902")]
    partial class _140003111902
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.ChequesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.StudentQuestionAnswersModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.StudentQuestionsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.StudentFinancialDebtsModel", b =>
                {
                    b.HasOne("DataModels.TrainingManagementModels.CourseMeetingStudentsModel", "CourseMeetingStudent")
                        .WithMany("StudentFinancialDebts")
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.StudentQuestionAnswersModel", b =>
                {
                    b.HasOne("DataModels.IdentitiesModels.UsersModel", "AnswerUser")
                    ...
                    b.HasOne("DataModels.TrainingManagementModels.StudentQuestionsModel", "StudentQuestion")
                        .WithMany("StudentQuestionAnswers")
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.StudentQuestionsModel", b =>
                {
                    ...
                    b.HasOne("DataModels.IdentitiesModels.UsersModel", "StudetUser")
                        .WithMany("StudentQuestions")
                        .HasForeignKey("StudetUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
