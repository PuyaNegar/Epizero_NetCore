...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210524101544_14000303-1445")]
    partial class _140003031445
    {
            ...
            modelBuilder.Entity("DataModels.HomeworksModels.HomeworkAnswersModel", b =>
                {
                    b.HasOne("DataModels.HomeworksModels.HomeworksModel", "HomeWork")
                        .WithOne("HomeworkAnswer")
                        .HasForeignKey("DataModels.HomeworksModels.HomeworkAnswersModel", "HomeWorkId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
