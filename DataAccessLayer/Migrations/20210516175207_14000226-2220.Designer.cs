...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210516175207_14000226-2220")]
    partial class _140002262220
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.TeachercheckoutSchedulesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TeachercheckoutSchedules");
                });

            modelBuilder.Entity("DataModels.FinancialsModels.TeachercheckoutsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("TeachercheckoutScheduleId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TeachercheckoutScheduleId")
                        .IsUnique();

                    b.ToTable("Teachercheckouts");
                });
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.CourseMeetingHomeWorkGradesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CourseMeetingHomeWorkGrades");
                });
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.TeachercheckoutSchedulesModel", b =>
                {
                    ...
                    b.HasOne("DataModels.FinancialsModels.TeacherPaymentMethodsModel", "TeacherPaymentMethod")
                        .WithMany("TeachercheckoutSchedules")
                        .HasForeignKey("TeacherPaymentMethodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.TeachercheckoutsModel", b =>
                {
                    b.HasOne("DataModels.FinancialsModels.TeachercheckoutSchedulesModel", "TeachercheckoutSchedule")
                        .WithOne("Teachercheckout")
                        .HasForeignKey("DataModels.FinancialsModels.TeachercheckoutsModel", "TeachercheckoutScheduleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DataModels.OrdersModels.OrdersModel", b =>
                {
                    b.HasOne("DataModels.TrainingManagementModels.CouponsModel", "Coupon")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.CourseMeetingHomeWorkGradesModel", b =>
                {
                    b.HasOne("DataModels.TrainingManagementModels.CourseMeetingsModel", "CourseMeeting")
                        .WithMany("CourseMeetingHomeWorkGrades")
                        .HasForeignKey("CourseMeetingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
