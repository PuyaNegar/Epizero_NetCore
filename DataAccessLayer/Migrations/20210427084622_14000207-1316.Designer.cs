...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210427084622_14000207-1316")]
    partial class _140002071316
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.ContentsModels.CoursePromoSectionGroupsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CoursePromoSectionGroups");
                });
            ...
            modelBuilder.Entity("DataModels.ContentsModels.CoursePromoSectionsModel", b =>
                {
                    ...
                    b.Property<int>("CoursePromoSectionGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CoursePromoSectionGroupId");
            ...
            modelBuilder.Entity("DataModels.ContentsModels.ProductPromoSectionsModel", b =>
                {
                    ...
                    b.Property<int>("ProductPromoSectionGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductPromoSectionGroupId");
            ...
            modelBuilder.Entity("DataModels.OrdersModels.CouponsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.OrdersModels.FinancialTransactionsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.OrdersModels.InvoicesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.OrdersModels.OrdersModel", b =>
                {
                    ...
                    b.Property<bool>("IsCalculatedDeliveryFee")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime?>("OrderAcceptDateTime")
                        .HasColumnType("datetime");

                    b.Property<DateTime?>("OrderConfirmStatusDateTime")
                        .HasColumnType("datetime");

                    b.Property<int?>("OrderConfirmStatusTypeId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PrepareDuration")
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("OrderConfirmStatusTypeId");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.CitiesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.SystemsModels.CountriesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.InvoiceStatusTypesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.InvoiceTypesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.LanguagesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.OrderConfirmStatusTypesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrderConfirmStatusTypes");
                });

            modelBuilder.Entity("DataModels.SystemsModels.OrderStatusTypesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.PaymentGatewaysModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.ProvincesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.SystemsModels.SchoolTypesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.SystemsModels.WeekDaysModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.ContentsModels.CoursePromoSectionsModel", b =>
                {
                    ...
                    b.HasOne("DataModels.ContentsModels.CoursePromoSectionGroupsModel", "CoursePromoSectionGroup")
                        .WithMany("CoursePromoSections")
                        .HasForeignKey("CoursePromoSectionGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataModels.ContentsModels.ProductPromoSectionsModel", b =>
                {
                    ...
                    b.HasOne("DataModels.ContentsModels.ProductPromoSectionGroupsModel", "ProductPromoSectionGroup")
                        .WithMany("ProductPromoSections")
                        .HasForeignKey("ProductPromoSectionGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DataModels.IdentitiesModels.StudentUserProfilesModel", b =>
                {
                    b.HasOne("DataModels.SystemsModels.CitiesModel", "City")
                        .WithMany("StudentUserProfiles")
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataModels.SystemsModels.SchoolTypesModel", "SchoolType")
                        .WithMany("StudentUserProfiles")
            ...
            modelBuilder.Entity("DataModels.OrdersModels.FinancialTransactionsModel", b =>
                {
                    b.HasOne("DataModels.OrdersModels.InvoicesModel", "Invoice")
            ...
            modelBuilder.Entity("DataModels.OrdersModels.InvoicesModel", b =>
                {
                    b.HasOne("DataModels.SystemsModels.InvoiceStatusTypesModel", "InvoiceStatusType")
                        .WithMany("Invoices")
                        .HasForeignKey("InvoiceStatusTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataModels.SystemsModels.InvoiceTypesModel", "InvoiceType")
                        .WithMany("Invoices")
                    ...
                    b.HasOne("DataModels.OrdersModels.InvoicesModel", "RefInvoice")
                        .WithOne()
                        .HasForeignKey("DataModels.OrdersModels.InvoicesModel", "RefInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DataModels.OrdersModels.OrdersModel", b =>
                {
                    b.HasOne("DataModels.OrdersModels.InvoicesModel", "FinalInvoice")
                        .WithMany("Orders")
                    ...
                    b.HasOne("DataModels.SystemsModels.OrderConfirmStatusTypesModel", "OrderConfirmStatusType")
                        .WithMany("Orders")
                        .HasForeignKey("OrderConfirmStatusTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DataModels.SystemsModels.OrderStatusTypesModel", "OrderStatusType")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("DataModels.OrdersModels.PaymentsModel", b =>
                {
                    ...
                    b.HasOne("DataModels.SystemsModels.PaymentGatewaysModel", "PaymentGateway")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("DataModels.SystemsModels.CitiesModel", b =>
                {
                    ...
                    b.HasOne("DataModels.SystemsModels.ProvincesModel", "Province")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("DataModels.SystemsModels.ProvincesModel", b =>
                {
                    b.HasOne("DataModels.SystemsModels.CountriesModel", "Country")
                        .WithMany("Provinces")
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.CoursesModel", b =>
                {
                    ...
                    b.HasOne("DataModels.SystemsModels.LanguagesModel", "Languages")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("DataModels.TrainingManagementModels.WeekSchedulesModel", b =>
                {
                    ...
                    b.HasOne("DataModels.SystemsModels.WeekDaysModel", "WeekDay")
                        .WithMany("WeekSchedules")
