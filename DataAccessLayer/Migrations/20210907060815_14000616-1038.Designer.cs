...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210907060815_14000616-1038")]
    partial class _140006161038
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.SalePartnerUserCustomCoursePricesModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CourseId", "SalePartnerUserId")
                        .IsUnique();

                    b.ToTable("SalePartnerUserCustomCoursePrices");
                });
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.SalePartnerUserCustomCoursePricesModel", b =>
                {
                    b.HasOne("DataModels.TrainingManagementModels.CoursesModel", "Course")
                        .WithMany("SalePartnerUserCustomCoursePrices")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
