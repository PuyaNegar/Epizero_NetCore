...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210427111041_14000207-1540")]
    partial class _140002071540
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.ContentsModels.OnlineExamPromoSectionGroupsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OnlineExamPromoSectionGroups");
                });
            ...
            modelBuilder.Entity("DataModels.ContentsModels.OnlineExamPromoSectionsModel", b =>
                {
                    ...
                    b.Property<int>("OnlineExamPromoSectionGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OnlineExamPromoSectionGroupId");
            ...
            modelBuilder.Entity("DataModels.ContentsModels.OnlineExamPromoSectionsModel", b =>
                {
                    ...
                    b.HasOne("DataModels.OnlineExamModels.OnlineExamsModel", "OnlineExam")
                        .WithMany("OnlineExamPromoSections")
                        .HasForeignKey("OnlineExamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataModels.ContentsModels.OnlineExamPromoSectionGroupsModel", "OnlineExamPromoSectionGroup")
                        .WithMany("OnlineExamPromoSections")
                        .HasForeignKey("OnlineExamPromoSectionGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
