...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210719063454_14000428-1102")]
    partial class _140004281102
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.SalesPartnerSharesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataModels.FinancialsModels.SalesPartnerSharesModel", b =>
                {
                    ...
                    b.HasOne("DataModels.OrdersModels.OrderDetailsModel", "OrderDetail")
                        .WithMany("SalesPartnerShares")
                        .HasForeignKey("OrderDetailId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataModels.IdentitiesModels.UsersModel", "PartnerUser")
                        .WithMany()
