...
{
   public class TeacherPaymentMethodTypesMap
    {
        public TeacherPaymentMethodTypesMap(EntityTypeBuilder<TeacherPaymentMethodTypesModel> entity)
        {
            entity.ToTable("TeacherPaymentMethodTypes");
