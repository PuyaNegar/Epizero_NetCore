...
{
   public class CourseSampleVideosMap
    {
        public CourseSampleVideosMap(EntityTypeBuilder<CourseSampleVideosModel> entity)
        {
            entity.ToTable("CourseSampleVideos");
            ...
            entity.HasOne(c => c.Course).WithMany(c => c.CourseSampleVideos).HasForeignKey(c => c.CourseId).OnDelete(DeleteBehavior.Restrict);
        }
    }
}
