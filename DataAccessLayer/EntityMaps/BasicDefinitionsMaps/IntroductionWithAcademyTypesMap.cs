...
{
   public class IntroductionWithAcademyTypesMap
    {
        public IntroductionWithAcademyTypesMap(EntityTypeBuilder<IntroductionWithAcademyTypesModel> entity)
        {
            entity.ToTable("IntroductionWithAcademyType");
