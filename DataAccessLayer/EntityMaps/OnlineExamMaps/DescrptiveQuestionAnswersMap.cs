...
{
   public class DescrptiveQuestionAnswersMap
    {
        public DescrptiveQuestionAnswersMap(EntityTypeBuilder<DescrptiveQuestionAnswersModel> entity)
        {
            entity.ToTable("DescrptiveQuestionAnswers");
