...
{
    public class DifficultyLevelTypesMap
    {
        public DifficultyLevelTypesMap(EntityTypeBuilder<DifficultyLevelTypesModel> entity)
        {
            entity.ToTable("DifficultyLevelTypes");
