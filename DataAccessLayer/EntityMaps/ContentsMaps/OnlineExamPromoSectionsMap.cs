...
{
    public class OnlineExamPromoSectionsMap
    {
        public OnlineExamPromoSectionsMap(EntityTypeBuilder<OnlineExamPromoSectionsModel> entity)
        {
            entity.ToTable("OnlineExamPromoSections");
