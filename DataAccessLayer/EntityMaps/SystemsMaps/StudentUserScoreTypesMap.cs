...
{
    public class StudentUserScoreTypesMap
    {
        public StudentUserScoreTypesMap(EntityTypeBuilder<StudentUserScoreTypesModel> entity)
        {
            entity.ToTable("StudentUserScoreTypes");
