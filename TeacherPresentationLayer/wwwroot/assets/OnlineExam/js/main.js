...
$(function () {
    ...
    $('body').on('change', 'input[type = radio]', function () {
        if ($('.field-item').is(':checked')) {
            $('.field-box').css('display','flex');
        } else {
    ...
    $.ajax({
        ...
        error: function (e) {
            ...
            if (e.status == 400) {
                ...
                toastr.error('ÎØÇ ÏÑ ÇÑÊÈÇØ ÈÇ ÓÑæÑ');
            }
            $(iconLoader).hide();
        },
...
$(function () {
    ...
    setInterval(function () { DataTransfer('/Home/KeepAlive', 'post', '', '', function (f) { }, function (e) { }) }, 60000);
});